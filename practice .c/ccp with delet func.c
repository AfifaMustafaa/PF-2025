 ...
 #include<conio.h>
 #include<string.h>
 	void enter(char name[200][20], char dept[200][20],char email[200][30],int rollno[200], long long num[200], float gpa[200],int *total);
 void view();
 void modify(char name[200][20], char dept[200][20], char email[200][30], int rollno[200], long long num[200], float gpa[200], int total);
void search(char name[200][20], char dept[200][20], char email[200][30], int rollno[200], long long num[200], float gpa[200], int total);
 void delet();
int main (){
	int a;
    char name[200][20];
...
void search(char name[][20], char dept[][20], char email[][30],
            int rollno[], long long num[], float gpa[], int total) {
...
void modify(char name[][20], char dept[][20], char email[][30],
            int rollno[], long long num[], float gpa[], int total) {
...
void delet(char name[][20], char dept[][20], char email[][30],
           int rollno[], long long num[], float gpa[], int *total) {
